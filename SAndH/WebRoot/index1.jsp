...
<html>
  ...
  <body
  style="background:url(images/bg2.png) no-repeat;  background-color:#f5fbfe">
  <!--  主体内容部分 -->
    <div id="wrap">
	      <!-- 引入头部信息 -->
		...
		<div class="containerAll">
			<div id="container">
				<div id="list" style="left: -600px;">
					<img src="images/5.jpg" alt="1" width="400px" height="240px" /> <img
						src="images/1.jpg" alt="1" width="400px" height="240px" /> <img
						src="images/2.jpg" alt="2" width="400px" height="240px" /> <img
						src="images/3.jpg" alt="3" width="400px" height="240px" /> <img
						src="images/4.jpg" alt="4" width="400px" height="240px" /> <img
						src="images/5.jpg" alt="5" width="400px" height="240px" /> <img
						src="images/1.jpg" alt="5" width="400px" height="240px" />
				</div>
				<div id="buttons">
		...
		<!-- 精彩博客 -->
			...
			<div class="comment">
				...
				<div class="01">
					<img src="images/001.jpg" width="200px" height="200px" />
				</div>
				<ul>
