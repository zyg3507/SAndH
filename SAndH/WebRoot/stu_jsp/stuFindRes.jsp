    ...
    <div class="body">
       ...
       <div class="body-left">
           	<ul>
	                ...
	                <li><a href="stu_jsp/stuFindRes.jsp"><img src="image/iconfont-weiduhuitie.png" width="15px" height="15px">&nbsp;&nbsp;查找资源</a></li>
       ...
       <div class="body-right">
          <form action="TeaFindResAction" method="post">
             请输入教师id：<input type="text" name="teaId"/>
