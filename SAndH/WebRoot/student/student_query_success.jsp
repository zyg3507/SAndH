					...
					<table width="100%" style="border-collapse:collapse;">
						...
						<s:iterator value="#session.student_list" var="stu">
							<tr class="list">
								...
								<td><a href="<%=path%>/student/Student_modify.action?sid=<s:property value="#stu.sid"/>"><s:property value="#stu.sname"/></a></td>
								<td><s:property value="#stu.gender" /></td>
								<td><s:date name="#stu.birthday" format="YYYY年MM月dd日" /></td>
								<td><s:property value="#stu.address" /></td>
								<td><a
									href="<%=path %>/student/Student_delete.action?sid=<s:property value="#stu.sid"/>"
