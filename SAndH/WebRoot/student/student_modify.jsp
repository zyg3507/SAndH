  ...
  <body>
	...
	<div class="body">
		<div class="main">
			...
			<div class="right">
				<div class="r-main">
					<strong>修改学生资料</strong> <br> <br>
					<form name="modifyForm"
						action="<%=path%>/student/Student_save.action" method="post">
						<table width="400">
							<tr>
								<td width="30%">学号：</td>
								<td><input type="text" name="sid"
									value='<s:property value="#session.modify_student.sid"/>'
							...
							<tr>
								...
								<td><input type="text" name="sname"
									value='<s:property value="#session.modify_student.sname"/>' placeholder="请输入小于10个字符的名字" style="width:200px;height:27px;"/>
								</td>
							</tr>
							<tr>
								<td>性别：</td>
								<td><s:if test='%{#session.modify_student.gender=="男"}'>
         ...
         <input type="radio" name="gender" value="女" checked="checked" />女
							...
							<tr>
								...
								<td><input name="birthday" type="text" id="control_date"
									...
									readonly="readonly"
									value="<s:date name="#session.modify_student.birthday" format="yyyy-MM-dd"/>" style="width:200px;height:27px;"/>
								</td>
							</tr>
							<tr>
								<td>地址：</td>
								<td><input type="text" name="address"
									value='<s:property value="#session.modify_student.address"/>' placeholder="请输入您的地址" style="width:200px;height:27px;"/>
								</td>
							</tr>
							<tr>
