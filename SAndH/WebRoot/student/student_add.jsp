  ...
  <body>
	...
	<div class="body">
		<div class="main">
			...
			<div class="right">
				<div class="r-main">
					<strong>添加学生资料</strong> <br> <br>
					<form name="addForm"
						action="<%=path%>/student/Student_add.action" method="post">
						<table width="400">
							<tr>
								<td width="30%">姓名：</td>
								<td><input type="text" name="sname" placeholder="请输入小于10个字符的名字" style="width:200px;height:27px;"/></td>
							</tr>
							<tr>
								<td>性别：</td>
